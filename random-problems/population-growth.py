...
* aug is an integer, percent a non-negative double in [0, 100], p0 and p are positive integers (> 0)
*
* Examples:
...
first 
"""
def population_growth(pb, percent, aug, p):
    
    years = 0
    current_year = pb
    while current_year < p:
        current_year = current_year + (current_year * (percent/100)) + aug
        years += 1 

    return years


print(population_growth(1500, 5, 100, 5000))
